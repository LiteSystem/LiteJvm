...
class VMEngine;
typedef void (VMEngine::*FunctionPointer)();
...
public:
     ...
     */
    static VMEngine& getInstance() {
        static VMEngine instance;
        return instance;
    }
     ...
     * @param
     */
    void startVMEngine(ClassRuntime *classRuntime);
...
private:
    ...
    VMEngine(VMEngine const&); // não permitir implementação do construtor de cópia
    void operator=(VMEngine const&); // não permitir implementação do operador de igual
